...
export const PROJECTS: Project[] = [
  {
    ...
    highlights: [
      { title: 'Immersive Discovery', description: 'Created a fluid, spatial navigation system allowing users to browse the collection as if walking through the physical galleries.', icon: 'auto_awesome' },
      { title: 'Optimized Performance', description: 'Achieved a perfect lighthouse score despite heavy WebGL usage, ensuring a smooth experience across all devices.', icon: 'speed' }
    ],
  ...
  },
  {
    ...
    highlights: [
      { title: 'Biometric Security', description: 'Zero-friction FaceID & TouchID authentication pipeline with hardware enclave encryption.', icon: 'fingerprint' },
      { title: 'Tactile Micro-interactions', description: 'Haptic feedback tuned to feel like physical button presses on high-frequency transactions.', icon: 'touch_app' }
    ],
  ...
  },
  {
    ...
    highlights: [
      { title: 'Roast Selector', description: 'Interactive flavor profile radar chart helping customers find their exact single-origin bean preferences.', icon: 'coffee' },
      { title: 'Sub-second Checkout', description: 'Integrated Apple Pay & Google Pay for seamless mobile single-tap coffee subscriptions.', icon: 'shopping_bag' }
    ],
  ...
  },
  {
    ...
    highlights: [
      { title: '3D Floorplan Viewer', description: 'Photorealistic WebGL render of high-value architectural properties with ambient light simulations.', icon: 'view_in_ar' },
      { title: 'Market Intelligence', description: 'Predictive valuation analytics with interactive charts and regional demographic heatmaps.', icon: 'insights' }
    ],
  ...
  },
  {
    ...
    shortDescription: 'In-browser analog synthesizer with real-time WebAudio WebGL waveform visualizers.',
    ...
    highlights: [
      { title: 'Low Latency Audio', description: 'Sub-10ms audio buffer processing using AudioWorklet nodes for immediate keyboard response.', icon: 'graphic_eq' }
    ],
  ...
  },
  {
    ...
    highlights: [
      { title: 'Distraction-Free Editor', description: 'ProseMirror powered block editor supporting custom typographical scales and footnotes.', icon: 'edit_note' }
    ],
...
export const EXPERIENCES: ExperienceItem[] = [
  { id: 'exp-1', role: 'Senior Frontend Engineer', period: '2021 — PRESENT', description: 'Leading UI architecture for premium FinTech applications. Focused on micro-interactions, performance optimization, and bridging the gap between design and engineering.' },
  { id: 'exp-2', role: 'Creative Developer', period: '2018 — 2021', description: 'Developed award-winning marketing sites and interactive web experiences for boutique agencies. Specialized in WebGL and complex CSS animations.' },
  { id: 'exp-3', role: 'UI Designer', period: '2015 — 2018', description: 'Started career in product design, establishing a strong foundation in typography, layout, and user empathy before transitioning to code.' }
];
