        ...
        <div className="mb-12 sm:mb-16">
          ...
          <div className="flex overflow-x-auto hide-scrollbar space-x-3 pb-2">
            {project.techStack.map((tech) => (
              <div
                key={tech}
                className="flex-none px-5 py-2.5 rounded-full bg-brand-accent/10 border border-brand-accent/30"
              >
        ...
        <div className="mb-16">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            {project.highlights.map((highlight, idx) => (
              <div
                key={idx}
                className="bg-brand-surface p-6 sm:p-8 rounded-[18px] border border-brand-border shadow-[0_4px_20px_rgba(15, 23, 42,0.04)] hover:-translate-y-1 transition-transform duration-300"
              >
