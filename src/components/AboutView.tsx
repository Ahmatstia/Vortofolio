    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-8 pt-8 sm:pt-16 pb-28">
      ...
      <section className="grid grid-cols-1 md:grid-cols-12 gap-8 md:gap-12 mb-16 sm:mb-20 items-center">
        ...
        <div className="col-span-1 md:col-span-7 order-2 md:order-1 flex flex-col justify-center">
          <span className="font-hanken text-xs uppercase tracking-widest text-[#2563EB] font-bold block mb-3">
            BIOGRAPHY
          </span>
          <h1 className="font-garamond text-4xl sm:text-6xl lg:text-7xl text-[#0F172A] font-bold mb-6 leading-[1.1]">
            The Person<br />
            Behind The Code
          </h1>
          <p className="font-hanken text-base sm:text-lg text-[#475569] max-w-2xl mb-8 leading-relaxed">
        ...
        <div className="col-span-1 md:col-span-5 order-1 md:order-2 relative mb-6 md:mb-0">
          <div className="relative w-full aspect-[4/5] rounded-2xl overflow-hidden shadow-[0_8px_30px_rgba(15, 23, 42,0.12)] border border-[#E2E8F0]">
            <img
              src={ABOUT_IMAGE}
              alt="ahmtstia"
              loading="eager"
          ...
          <div className="absolute -bottom-6 -right-6 w-32 h-32 border-4 border-[#2563EB] rounded-full opacity-50 -z-10 pointer-events-none" />
          <div className="absolute -top-4 -left-4 w-16 h-16 bg-[#2563EB] opacity-20 rounded-full blur-xl -z-10 pointer-events-none" />
        </div>
      </section>

      {/* Divider */}
      <hr className="border-[#E2E8F0] mb-16 sm:mb-20 w-full" />

      {/* Timeline & Skills Section */}
      <section className="grid grid-cols-1 md:grid-cols-12 gap-10 lg:gap-16">
        {/* Experience Timeline */}
        <div className="col-span-1 md:col-span-7">
          <h2 className="font-garamond text-3xl sm:text-4xl text-[#0F172A] font-bold mb-10">
            Experience
          </h2>
